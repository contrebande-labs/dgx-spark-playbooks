...
export class EmbeddingsService {
  ...
  private dimension: number = 4096; // Dimension for gte-modernbert-base
  ...
  private constructor() {
    this.apiUrl = process.env.EMBEDDINGS_API_URL || 'http://localhost:8080';
    this.modelId = process.env.EMBEDDINGS_MODEL_ID || 'nvidia/llama-embed-nemotron-8b';
